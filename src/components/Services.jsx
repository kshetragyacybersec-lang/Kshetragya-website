      ...
      <div className="svc-head">
        <div>
          ...
          <h2 className="sec-h dark" id="services-heading">
            Four disciplines.
            <br />
            <em>Eleven services.</em>
          </h2>
        </div>
        <p className="svc-note">
          From the network up: infrastructure, defence, testing, and governance. Each service can be
          scoped and delivered on its own, or combined into a full security program.
        </p>
      </div>
