    ...
    services: [
      {
        ...
        deliverables: ['Site visit and needs assessment', 'Design and staged rollout', 'Full documentation of the setup', 'Support through handover'],
      },
      {
        ...
        deliverables: ['Review of current network setup', 'VLAN segmentation and routing plan', 'Configuration of switches/routers', 'Rollout done in planned stages, not all at once'],
      },
      {
        ...
        deliverables: ['On-site survey and camera placement plan', 'Installation and NVR/DVR setup', 'Secure remote access configuration', 'Team walkthrough on daily use'],
      },
    ],
  },
  {
    ...
    services: [
      {
        ...
        deliverables: ['Review of current setup and traffic', 'Rule set built on least privilege', 'Deployment with minimal disruption', 'Ongoing monitoring afterward'],
      },
      {
        id: 'soc-as-a-service',
        ...
        deliverables: ['Mapping of your environment', "Baseline period to learn what's normal", '24/7 monitoring and alert triage', 'Clear guidance only when action is needed'],
      },
      {
        ...
        deliverables: ['Fast containment of the threat', 'Root cause investigation', 'Evidence preserved for forensics', 'Report with recommendations to prevent repeat'],
      },
      {
        ...
        deliverables: ['Review against hardening benchmarks', 'Prioritized list of findings', 'Hands-on remediation', 'Check afterward to confirm nothing broke'],
      },
    ],
  },
  {
    ...
    services: [
      {
        ...
        deliverables: ['Scoping and reconnaissance', 'Automated scan + manual testing', 'Report ranked by severity', 'Free retest after fixes'],
      },
      {
        ...
        deliverables: ['Authenticated + unauthenticated testing', 'Manual exploitation of key flows', 'Findings with proof of concept', 'Fix guidance for each issue'],
      },
    ],
  },
  {
    ...
    services: [
      {
        ...
        deliverables: ['Gap assessment against framework', 'Review of policies and controls', 'Prioritized remediation roadmap', 'Support through audit readiness'],
      },
      {
        ...
        deliverables: ['Review of IAM, storage & network config', 'Benchmarked against cloud security best practices', 'Prioritized list of misconfigurations found', 'Remediation plan your team can act on'],
      },
    ],
  },
];
